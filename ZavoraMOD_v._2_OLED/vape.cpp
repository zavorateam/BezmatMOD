...
float Vape::values[5] = {
  3.0, // минимальное напряжение
  10.0, // отсечка затяжки
  30.0, // сон
  0.0, // общее время затяжки
  0.0  // предыдущее время затяжки
  }; 
static const int menu_args1[6] = {3, 12, 15, 10, 10, 7};   // x, y, n, h, radius ,size strArr;
static const int menu_args2[6] = {2, 25, 5,  25, 3,  4};
static const char* menu_strings1[7] = {"VOLT", "WATT", "COIL", "GAME", "TUNE", "INFO", "SHTD"}; //пункты меню
static const char* menu_strings2[4] = {"MVOLT", "CUTOFF", "SLEEP", "\n back"}; //пункты настроек
//============ДОПОЛНИТЕЛЬНЫЕ НАСТРОЙКИ=============
//=====================преференции=================
